...
enum Opcodes : unsigned char
{
	...
	OP_ERR, //Raise error. OPR: error code. Stack: -0+0
	...
	OP_CALLPTR, //Call function by managed ptr. OPR: 0. Stack: -x+1?
	OP_CALLNATIVE, //Call function by native ptr. Stack: -x+1?
	...
	OP_BRANCHERR, //Set error handler dest. OPR: relative (unsigned). Stack: -0+0
